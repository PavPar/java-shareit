...
public class ItemController {
    ...
    @PostMapping
    public ItemDto add(@RequestHeader(Constants.HeaderUserIdField) Long ownerId, @RequestBody ItemCreateDto dto) {
        return service.add(ownerId, dto);
    }

    @PatchMapping("{id}")
    public ItemDto update(@RequestHeader(Constants.HeaderUserIdField) Long ownerId, @PathVariable long id, @RequestBody ItemUpdateDto dto) {
        return service.update(ownerId, id, dto);
    }

    @PostMapping("{id}/comment")
    public CommentDto addComment(@RequestHeader(Constants.HeaderUserIdField) Long ownerId, @PathVariable long id, @RequestBody CommentCreateDto dto) {
